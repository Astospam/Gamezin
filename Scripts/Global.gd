	...
	match monster_recep:
		...
		2:
			if randf() < 1.0 - monster_recep_prob:
				...
				monster_recep_prob -= 0.1
				var locais = ["terreo", "primeiro_andar", "segundo_andar", "terceiro_andar"]
